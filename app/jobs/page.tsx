        ...
        <div className="space-y-8">
          <div className="rounded-lg bg-white p-6 shadow-md">
            <div className="flex flex-col items-start gap-4 md:flex-row">
              ...
              <div className="flex-grow">
                <h2 className="mb-2 text-2xl font-semibold">Senior Web Developer</h2>
                <p className="mb-4 text-gray-600">TechCorp Inc. | 2020 - Present</p>
          ...
          <div className="rounded-lg bg-white p-6 shadow-md">
            <div className="flex flex-col items-start gap-4 md:flex-row">
              ...
              <div className="flex-grow">
                <h2 className="mb-2 text-2xl font-semibold">Full Stack Developer</h2>
                <p className="mb-4 text-gray-600">WebSolutions Co. | 2017 - 2020</p>
                <ul className="list-inside list-disc">
          ...
          <div className="rounded-lg bg-white p-6 shadow-md">
            <div className="flex flex-col items-start gap-4 md:flex-row">
              ...
              <div className="flex-grow">
                <h2 className="mb-2 text-2xl font-semibold">Frontend Developer</h2>
